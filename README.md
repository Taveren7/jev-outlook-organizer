...
The dashboard supports manual Type corrections, optional learning from confirmed corrections, and guarded reclassification, retry and undo, documented in [the resilience guide](docs/resilience.md). Review operations use expiring previews and the durable audit; private customer/supplier/internal context is configurable.
